...
// console.log(Math.pow(Math.round(Math.abs(-5.9)))); //nan
// // 4-karekök alsın 6.0
...
// //indexof aradığın kelime kaçıncı indexde başlıyor
...
// //concat olan degiskenin sonuna ekler

// vocabulary=vocabulary.concat("sona ekle");
// console.log(vocabulary); 

// //replace yapısı soldakini sağdakine değiştirir
// vocabulary=vocabulary.replace(vocabulary,"yeni değiştir");
// console.log(vocabulary); // 0<=X<=3-1

// Kullanıcı tarafından girilen bir kelimenin(prompt)
//let userDate=prompt("Lütfen bir şeyler yazınız");
//S-1) Kaç karakterlidir ?
// let userDate=prompt("Lütfen bir şeyler yazınız");
// let kSay=userDate.length;
// console.log(`${userDate} kelimesi ${kSay} karakterlidir`);
...
/////////////////////////////////////////////
// callback, promise, asyn-await
    // arr.push(44); //sonuna ekler
    // arr.unshift(23); //başına ekler
    // arr.pop(); //sondan bir eleman çıkartır
    // arr.shift(); //baştan bir eleman çıkartır
    // arr.reverse(); //tersine çevirir
    // arr.sort(); //küçükten büyüğe doru
    // arr.sort().reverse(); //tersine çevirir küçükten büyüğe doru